...
import 'package:pregfit/Screens/Camera/input_image.dart';
...
class _CameraState extends State<Camera> {
  ...
  void initState() {
    ...
    socket.on('imageResponse', (data) {
      ...
      if (showImage && poseClass != widget.jenisYoga) {
  ...
  void getGif() {
    if (widget.jenisYoga == 'Glute Bridge Pose') {
      urlGif = 'assets/images/gb.gif';
    } else if (widget.jenisYoga == 'Bird Dog Pose') {
      urlGif = 'assets/images/bdp.gif';
    } else if (widget.jenisYoga == 'Cat Cow Pose') {
      urlGif = 'assets/images/cc.gif';
    } else if (widget.jenisYoga == 'Child Pose') {
      urlGif = 'assets/images/cp.gif';
    } else if (widget.jenisYoga == 'Lateral Leg Raise Pose') {
      urlGif = 'assets/images/llr.gif';
    } else if (widget.jenisYoga == 'Side Clamp Pose') {
      urlGif = 'assets/images/sc.gif';
    } else if (widget.jenisYoga == 'Side Bend Pose') {
      urlGif = 'assets/images/sb.gif';
    } else if (widget.jenisYoga == 'Savasana Pose') {
      urlGif = 'assets/images/S.gif';
    } else {
      urlGif = 'assets/images/GLUTE-BRIDGE.gif';
    }
  }
